 ...
 * theme-settings.php
 *
 * Provides theme settings for hpv24
 */
 ...
 */
function hpv24_form_system_theme_settings_alter(&$form, FormStateInterface $form_state, $form_id = NULL) {
  ...
  foreach ($hpv24_contained_regions as $contained_region_name => $contained_region_title) {
