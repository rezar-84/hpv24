...
if(!class_exists('element_gva_gmap')):
   class element_gva_gmap{
      ...
      ?>
         ...
         <script src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('modins')) ?>/assets/vendor/gmap3.js"></script>
         <script src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('modins')) ?>/assets/vendor/jquery.ui.map.min.js"></script>
