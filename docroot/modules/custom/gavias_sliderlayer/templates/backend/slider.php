      ...
      <div class="g-wrapper">
       <div class="gavias-heading">Slide options</div>
        <table>
          ...
          <tr>
            <td width="33%">
              <label class="g-label">Video Source</label>
            ...
            <td>
              <label class="g-label">Video Start At</label>
              <input name="video_start_at" type="text" class="slide-option form-text"/>
            </td>
            <td>
             <label class="g-label">Video End At</label>
